...
EditText editTextCode,editTextPhone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register__menu__phone_number);
        init();
        ...
        findViewById(R.id.btn_confrim_code).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                verifySignInCode();
            }
    ...
    private void init() {
        editTextCode = findViewById(R.id.code_receive);
