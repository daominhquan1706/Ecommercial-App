...
import com.example.shiper.MapBoxActivity;
...
public class Adapter_HoaDon_item extends RecyclerView.Adapter<Adapter_HoaDon_item.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Adapter_HoaDon_item.ViewHolder holder, int position) {
        final Orders orders_item = list_orders.get(position);
