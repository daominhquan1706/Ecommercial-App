package com.example.test1706.SQLite;
...
public class ViewedProductsSqliteHelper extends SQLiteOpenHelper {
    ...
    // Tên bảng: Cart.
    private static final String TABLE_CART = "ViewedProducts";
    ...
    public ViewedProductsSqliteHelper(Context context) {
