...
import com.example.adminr.Adapter.ImageAdapter;
import com.example.adminr.Adapter.Product_Recycle_Adapter_NiteWatch;
import com.example.adminr.model.CartSqliteHelper;
import com.example.adminr.model.Product;
...
public class NiteWatchFragment extends Fragment {
    ...
    private List<Product> getProductdata() {
        ...
        Product dongho1 = new Product(
                ...
                300,
                "Sport",
                "https://firebasestorage.googleapis.com/v0/b/adminr-8ed39.appspot.com/o/list_dong_ho_nite_watch%2Fday_dongho_201.png?alt=media&token=9df5d3fd-95e7-4f24-accf-df105ddaa63b",
                "https://firebasestorage.googleapis.com/v0/b/adminr-8ed39.appspot.com/o/list_dong_ho_nite_watch%2Fnight_dongho_201.png?alt=media&token=b7f989fa-aa58-4ba1-831e-dc5e61ae04f1");

        Product dongho2 = new Product(
                "Hawk t100",
                300,
                "Sport",
                "https://firebasestorage.googleapis.com/v0/b/adminr-8ed39.appspot.com/o/list_dong_ho_nite_watch%2Fday_dongho_t100.png?alt=media&token=43f33315-702a-4484-8ba2-f32e5dd1b941",
                "https://firebasestorage.googleapis.com/v0/b/adminr-8ed39.appspot.com/o/list_dong_ho_nite_watch%2Fnight_dongho_t100.png?alt=media&token=ea78305e-4ca6-458e-be99-9a85954c5fbe");

        Product dongho3 = new Product(
                "Hawk z400",
                300,
                "Sport",
                "https://firebasestorage.googleapis.com/v0/b/adminr-8ed39.appspot.com/o/list_dong_ho_nite_watch%2Fday_dongho_z400t.png?alt=media&token=43c97dab-8cc7-4d6e-9ff1-c3012cd7d2f6",
                "https://firebasestorage.googleapis.com/v0/b/adminr-8ed39.appspot.com/o/list_dong_ho_nite_watch%2Fnight_dongho_z400t.png?alt=media&token=923c23cb-912d-4fa3-9642-f9abbd7f9f20");
