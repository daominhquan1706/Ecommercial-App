...
-- --------------------------------------------------
-- Date Created: 02/23/2019 14:12:34
-- Generated from EDMX file: C:\gitkraken project\eCommercial-15dh110176\eCommercial\Model1.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [eCommercial-15dh110176_db];
GO
...
-- Creating primary key on [IdMatHang] in table 'MatHangs'
ALTER TABLE [dbo].[MatHangs]
ADD CONSTRAINT [PK_MatHangs]
    PRIMARY KEY CLUSTERED ([IdMatHang] ASC);
GO
