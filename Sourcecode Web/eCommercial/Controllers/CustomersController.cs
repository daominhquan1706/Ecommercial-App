...
namespace eCommercial.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "First_Name,Last_Name,Phone,Address,Customer_Id,Avatar")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "First_Name,Last_Name,Phone,Address,Customer_Id,Avatar")] Customer customer)
        {
            if (ModelState.IsValid)
            {
